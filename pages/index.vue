<template>
  <main class="flex min-h-screen flex-col items-center justify-center px-4">
    <div class="flex max-w-[600px] flex-col items-center text-center">
      <img
        src="/avatar-300x300.jpg"
        alt="Markus Aurich"
      ...
      <div class="flex gap-2">
        <a
          href="https://linkedin.com/in/monsjovis"
          target="_blank"
        ...
        <a
          href="https://github.com/monsjovis"
          target="_blank"
          rel="noopener noreferrer"
          class="social-icon"
          aria-label="GitHub"
...
.social-icon {
  @apply text-black transition-all duration-200 hover:scale-110 hover:opacity-75;
}
</style>
